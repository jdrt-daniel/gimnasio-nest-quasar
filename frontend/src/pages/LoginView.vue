<template>
  <div class="flex justify-center full-sreen">
    <q-card
      class="absolute-center"
      :class="$q.screen.xs || $q.screen.sm ? 'mobile' : 'my-card'"
    >
      <!-- <img src="https://cdn.quasar.dev/img/mountains.jpg" /> -->
      <q-card-section class="bg-cyan-8 text-center q-pt-lg">
        <svg
          id="logo"
          viewBox="0 0 483 483"
          ...
          v-html="Digitalizer"
        ></svg>
        <div class="text-h4 text-white">INICIAR SESIÓN</div>
      </q-card-section>
...
const onLogin = async () => {
  try {
    ...
    if (data.code === 200) {
      ...
      ToastNotification('positive', 'check', data.message);
      user.verifyUser();
      router.push('/');
    } else {
      onReset();
      ToastNotification('negative', 'warning', 'Credenciales invalidas');
    }
  } catch (error) {
    onReset();
    ToastNotification('negative', 'warning', 'Credenciales invalidas');
